...
namespace APIVerve\Anagramdetector;
...
/**
 * Client for the Anagram Detector API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/anagramdetector?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/anagramdetector';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\AnagramdetectorClient] {$message}\n";
        }
    }
}
