...
const (
	baseURL        = "https://api.apiverve.com/v1/anagramdetector"
	defaultTimeout = 30 * time.Second
)

// Client is the Anagram Detector API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Anagram Detector API client.
...
// Execute makes a request to the Anagram Detector API with typed parameters.
//
