...
namespace APIVerve.API.AnagramDetector
{
    ...
    /// <summary>
    /// Client for the AnagramDetector API
    /// </summary>
    public class AnagramDetectorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/anagramdetector";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "ignorecase", new ValidationRule { Type = "boolean", Required = false } },
            { "ignorespaces", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public AnagramDetectorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public AnagramDetectorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public AnagramDetectorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, AnagramDetectorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(AnagramDetectorQueryOptions options)
        {
        ...
        public ResponseObj Execute(AnagramDetectorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(AnagramDetectorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(AnagramDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(AnagramDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(AnagramDetectorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(AnagramDetectorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(AnagramDetectorQueryOptions options)
        {
