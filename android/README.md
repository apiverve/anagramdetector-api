...
```gradle
dependencies {
    implementation 'com.github.apiverve:anagramdetector-api:1.1.12'
}
```
...
AnagramDetectorAPIClient client = new AnagramDetectorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/anagramdetector](https://docs.apiverve.com/ref/anagramdetector)
...
- **Documentation:** [https://docs.apiverve.com/ref/anagramdetector](https://docs.apiverve.com/ref/anagramdetector)
- **Issues:** [GitHub Issues](https://github.com/apiverve/anagramdetector-api/issues)
